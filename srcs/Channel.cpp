...
/*   Updated: 2026/02/07 14:25:51 by mglikenf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool Channel::isInviteOnly(void) const { return this->_modes.count('i'); }
bool Channel::isTopicRestricted(void) const { return this->_modes.count('t'); }
bool Channel::hasKey(void) const { return this->_modes.count('k'); }
bool Channel::hasUserLimit(void) const { return this->_modes.count('l'); }
size_t Channel::getMemberCount(void) const { return this->_members.size(); }
unsigned int Channel::getUserLimit(void) const { return this->_userLimit; }
...
const std::string& Channel::getTopicSetter(void) const { return this->_topicSetter; }
time_t Channel::getTopicTime(void) const { return this->_topicTime; }
